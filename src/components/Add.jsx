...
const Add = () => {
  ...
  return (
    <div className="container mx-auto p-6 max-w-lg">
      <h1 className="text-3xl font-bold text-black-700 mb-6">Add New Task</h1>
      <button
        onClick={handleBack}
      ...
      <form onSubmit={handleSubmit} className="space-y-4">
        ...
        <button
          type="submit"
          className="w-full bg-blue-500 text-white px-4 py-2 rounded-md hover:bg-blue-700 transition cursor-pointer"
        >
          Submit
        </button>
      </form>
